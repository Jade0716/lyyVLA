...
TASKS="${TASKS:-auto}"
DATASET_NAMES="${DATASET_NAMES:-RoboMemArena-Multi-Object-Counting,RoboMemArena-Multi-Object-Occlusion,RoboMemArena-Multi-Object-Sequence,RoboMemArena-Multi-Object-Transferring}"
