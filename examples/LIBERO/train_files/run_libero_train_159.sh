...
config_yaml=${config_yaml:-./examples/LIBERO/train_files/starvla_cotrain_libero_twochunk_v2_flowmatching_159.yaml}
run_id=${run_id:-159_10-twochunk-flowmatching-$(date +%Y%m%d_%H%M%S)}
