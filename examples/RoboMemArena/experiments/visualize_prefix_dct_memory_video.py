#!/usr/bin/env python3
"""Render a RoboMemArena video with the active prefix DCT memory curve on top."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--dataset-dir",
        type=Path,
        default=Path("/15T/liuyuyan/robomemarena_lerobot/Multi-Object_Occlusion"),
    )
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("examples/RoboMemArena/experiments/prefix_dct_memory_episode_000000.mp4"),
    )
